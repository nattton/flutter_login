...
void main() {
  group('LoginForm', () {
    ...
    testWidgets('adds UsernameChanged to LoginBloc when username is updated',
        (tester) async {
    ...
    testWidgets('adds PasswordChanged to LoginBloc when password is updated',
        (tester) async {
    ...
    testWidgets('LoginSubmitted is added to LoginBloc when continue is tapped',
      ...
      verify(() => loginBloc.add(const Submitted())).called(1);
    });
